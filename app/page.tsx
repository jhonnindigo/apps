              ...
              <div className="flex flex-col justify-center space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">Ver demostración</Link>
                  </Button>
                </div>
              ...
              <div className="relative">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-3xl shadow-xl overflow-hidden p-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <Button
                      className="w-full bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-zinc-900 font-bold border-0 shadow-lg shadow-amber-500/20 h-12"
                      asChild
                    >
                      <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">
            ...
            <div className="mt-12 text-center">
              <div className="inline-block rounded-3xl bg-zinc-900 border border-zinc-800 p-6 shadow-xl">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <Button
                    className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white border-0 shadow-lg shadow-pink-500/20 px-8"
                    asChild
                  >
                    <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">Quiero mis bonos</Link>
                  </Button>
                </div>
              </div>
            </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-3xl shadow-xl overflow-hidden">
                  <div className="p-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <Button
                        className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white border-0 shadow-lg shadow-emerald-500/20 h-12"
                        asChild
                      >
                        <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">Quiero esta garantía</Link>
                      </Button>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex flex-col md:flex-row gap-8 items-center">
                    <div className="flex-1 space-y-6">
                      ...
                      <Button
                        className="bg-gradient-to-r from-red-500 to-amber-500 hover:from-red-600 hover:to-amber-600 text-white border-0 shadow-lg shadow-red-500/20 px-8 h-12"
                        asChild
                      >
                        <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">
          ...
          <div className="container px-4 md:px-6">
            ...
            <Tabs defaultValue="trimestral" className="w-full max-w-5xl mx-auto mb-12">
              <TabsList className="grid w-full grid-cols-3 bg-zinc-800">
                ...
                <TabsTrigger value="semestral" className="data-[state=active]:bg-zinc-900">
                  Semestral (15% dto.)
                </TabsTrigger>
                <TabsTrigger value="anual" className="data-[state=active]:bg-zinc-900">
                  Anual (20% dto.)
                </TabsTrigger>
              </TabsList>
                    ...
                    <div className="h-full bg-zinc-900 border border-zinc-800 rounded-3xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-10 transition-all duration-200 group-hover:shadow-xl group-hover:border-zinc-700">
                      <div className="flex flex-col h-full">
                        ...
                        <Button
                          ...
                          asChild
                        >
                          <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">Empezar Ahora</Link>
                        </Button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="h-full bg-zinc-900 border-2 border-purple-900/50 rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-10 mt-4">
                      <div className="flex flex-col h-full">
                        ...
                        <Button
                          className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white border-0 shadow-lg shadow-purple-500/20 rounded-xl h-12"
                          asChild
                        >
                          <Link href="https://api.leadconnectorhq.com/widget/bookings/holain">Quiero Mi Sistema</Link>
                        </Button>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="h-full bg-zinc-900 border border-zinc-800 rounded-3xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-10 transition-all duration-200 group-hover:shadow-xl group-hover:border-zinc-700">
                      <div className="flex flex-col h-full">
                        <div className="mb-6">
                          ...
                          <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-white">$85 USD</span>
                            <span className="text-zinc-400">setup</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-zinc-400">luego $425/mes</span>
                            <span className="text-xs text-zinc-600 line-through">$500/mes</span>
                          </div>
                        </div>
                        <p className="text-zinc-400 mb-6">Sprint de adquisición con sistema básico listo en 72h.</p>
                        <ul className="space-y-3 mb-8 flex-grow">
                    ...
                    <div className="h-full bg-zinc-900 border-2 border-purple-900/50 rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-10 mt-4">
                      <div className="flex flex-col h-full">
                        <div className="mb-6">
                          ...
                          <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-white">$425 USD</span>
                            <span className="text-zinc-400">setup</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-zinc-400">luego $850/mes</span>
                            <span className="text-xs text-zinc-600 line-through">$1,000/mes</span>
                          </div>
                        </div>
                        <p className="text-zinc-400 mb-6">Embudo + CRM + campañas + dashboard. Todo activo.</p>
                        <ul className="space-y-3 mb-8 flex-grow">
                    ...
                    <div className="h-full bg-zinc-900 border border-zinc-800 rounded-3xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-10 transition-all duration-200 group-hover:shadow-xl group-hover:border-zinc-700">
                      <div className="flex flex-col h-full">
                        <div className="mb-6">
                          ...
                          <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-white">$2,125</span>
                            <span className="text-zinc-400">/mes</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-zinc-400">Exclusividad por zona</span>
                            <span className="text-xs text-zinc-600 line-through">$2,500/mes</span>
                          </div>
                        </div>
                        <p className="text-zinc-400 mb-6">
                          Acceso completo, equipo estratégico y optimización continua. Exclusividad por zona.
                    ...
                    <div className="h-full bg-zinc-900 border border-zinc-800 rounded-3xl shadow-sm p-4 sm:p-6 md:p-8 lg:p-10 transition-all duration-200 group-hover:shadow-xl group-hover:border-zinc-700">
                      <div className="flex flex-col h-full">
                        <div className="mb-6">
                          ...
                          <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-white">$80 USD</span>
                            <span className="text-zinc-400">setup</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-zinc-400">luego $400/mes</span>
                            <span className="text-xs text-zinc-600 line-through">$500/mes</span>
                          </div>
                        </div>
                        <p className="text-zinc-400 mb-6">Sprint de adquisición con sistema básico listo en 72h.</p>
                    ...
                    <div className="h-full bg-zinc-900 border-2 border-purple-900/50 rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-10 mt-4">
                      <div className="flex flex-col h-full">
                        <div className="mb-6">
                          ...
                          <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-white">$400 USD</span>
                            <span className="text-zinc-400">setup</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-zinc-400">luego $800/mes</span>
                            <span className="text-xs text-zinc-600 line-through">$1,000/mes</span>
                          </div>
                        </div>
                        <p className="text-zinc-400 mb-6">Embudo + CRM + campañas + dashboard. Todo activo.</p>
